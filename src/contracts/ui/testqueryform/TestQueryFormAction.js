import QueryTest from '../../../../build/contracts/QueryTest.json'
  ...
  if (typeof web3 !== 'undefined') {
    ...
    web3.eth.getCoinbase((error, coinbase) => {
        ...
        queryTest.deployed().then(function (queryTestContractInstance) {
          queryTestContractInstance.testOracleQuery(
            ...
            for (let i = 0; i < queryTransactionResults.logs.length; i++) {
              ...
              if (log.event === "QueryScheduled") {
                // We found the event!
                console.log("Scheduled Query Id = " + log.args.queryIDScheduled);
                queryID  = log.args.queryIDScheduled;
              }
            }

            // TODO: not sure where to acutally handle this event
            queryTestContractInstance.QueryCompleted().watch(function (error, result) {
              console.log(result);
              ...
              queryTestContractInstance.getQueryResults.call(queryID).then(function (queryResults) {
